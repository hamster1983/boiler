...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<div style="padding: 0" class="col-sm-6 col-md-6 col-lg-4" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		<div class="bx-newslist-block" id="newsWrap">
...
<!-- КАРТИНКА -->
			...
			<div class="bx-newslist-img">
				<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<a href="<?=$arItem["DETAIL_PAGE_URL"]?>" style="margin: 0"><img
...
<!-- ДАТА -->
		<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
			<div class="col-xs-5">
				<div class="bx-newslist-date" id="newsDate"><i class="fa fa-calendar-o"></i> <?echo $arItem["DISPLAY_ACTIVE_FROM"]?></div>
			</div><br />
		<?endif?>
